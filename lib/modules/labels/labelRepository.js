...
var LabelRepository = function(dbAPI) {
  this.dbAPI = dbAPI;
  this.table = 'labels';
  this.dbAPI.helpers.registerTable(this.table);
};

LabelRepository.prototype.all = function() {
...
LabelRepository.prototype.getById = function(id) {
  var deferred = Q.defer();
...
LabelRepository.prototype.delete = function(id) {
  var deferred = Q.defer();
